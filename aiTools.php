...
<section class="tabs content18 cid-smH7yzCdHX" id="tabs1-p">    
    ...
    if(isset($_POST['cervical-predict'])){
      ...
      $o27= $_POST['otherD'];
       ...
       $json2 =  file_get_contents('https://b318-2401-4900-1c5a-a638-98b-86c4-8b70-37e3.ngrok.io/cervicalcancer/', false, stream_context_create([
        'http' => [
            'method' => 'POST',
        ...
        <div class="media-container-row align-center mbr-white">
            ...
            <div class="row social-row">
                <div class="social-list align-right pb-2">
                    <div class="soc-item">
                        <a href="https://github.com/sakshi300699/HackNSolve" target="_blank">
