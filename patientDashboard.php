            ...
            <div class="card col-12 col-lg-10">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        <h4 class="card-title mbr-fonts-style align-center mb-4 display-1"><strong style="font-family: 'Kaushan Script', cursive;">Patient Dashboard</strong></h4>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="dashboard-main-card">
                    ...
                    <div id="doctor-details">
                        <div style="display:flex"> 
                            <div style="color:#ff4167;font-weight:500;margin-right:10px">Doctor Name: </div>
                            <div> Dr. Shushmita Agrawal</div>
                        </div>
                        <div style="display:flex">
                            <div style="color:#ff4167;font-weight:500;margin-right:10px">Hospital Name: </div>
                    ...
                    if($res){
                        while($row=$res->fetch_array()){
                            ...
                            <div>
                            <h2 style='color:#ff4167'>$title</h2>
                            </div>
                            $prescription
                             </div>
                            ";
        ...
        <div class="media-container-row align-center mbr-white">
            ...
            <div class="row social-row">
                <div class="social-list align-right pb-2">
                    <div class="soc-item">
                        <a href="https://github.com/ShrutiRawal/SheCure" target="_blank">
