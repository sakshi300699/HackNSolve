...
<html  >
  <head>
    ...
    <link rel="shortcut icon" href="assets/images/MedForHer.png" type="image/x-icon">
    <meta name="description" content="">
    
    
    <title>MedForHer</title>
        ...
        <div class="container-fluid">
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="index.php">
                        <img src="assets/images/MedForHer_logo2.png" alt="MedForHer" style="height: 5rem;">
                    </a>
                </span>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                    <li class="nav-item">
                        <a class="nav-link link text-black display-4" href="#tabs1-p">Diagnostic Tools</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row justify-content-end">
            <div class="col-12 col-lg-5">
                <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1">
                    <strong style="font-family: 'Kaushan Script', cursive;">MedForHer</strong>
                </h1>
                <div class="mbr-section-btn mt-3">
                    <a class="btn  display-4" href="#image1-m" style="background-color: #fa66a7; color:white;">Click to Explore</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            <div class="col-12 col-lg-5">
                <div class="image-wrapper">
                    <img src="assets/images/women.png" alt="We're in this together">
            ...
            <div class="col-12 col-lg">
                <div class="text-wrapper">
                    <h3 class="mbr-section-title mbr-fonts-style mb-3 display-5">
                        <strong style="font-family: 'Kaushan Script', cursive; color:#4588c3";>About Us</strong>
                    </h3>
...
<section class="features1 cid-smH6sYk3vI mbr-parallax-background" id="features1-n">
    ...
    <div class="mbr-overlay" style="opacity: 0.5; background-color: #fa66a7;">
    </div>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">
                    <strong style="font-family: 'Kaushan Script', cursive;" >Features</strong>
                </h3>
            ...
            <div class="card col-12 col-md-6 col-lg-3">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        ...
                        <p class="card-text mbr-fonts-style display-7">
                            Timely assistance can be the key to effective treatment, and with MedForHer you don't need
...
<section class="features4 cid-smH9YlleGZ" id="features4-q" style="background:#fa66a7;">
        ...
        <div class="row mt-4">
            <div class="item features-image сol-12 col-md-6 col-lg-3">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/43071.jpg" alt="" title="" data-slide-to="2">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5"><strong>Health Diagnosis Tools</strong></h5>
                    </div>
                    <div class="mbr-section-btn item-footer mt-2"><a href="labs.html" class="btn item-btn btn-secondary display-7">Use Now &gt;</a></div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="card col-12 col-lg-10">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        <h4 class="card-title mbr-fonts-style align-center mb-4 display-1"><strong style="font-family: 'Kaushan Script', cursive;">
                            GO TO DASHBOARD
                        </strong></h4>
                        <p class="mbr-text mbr-fonts-style mb-4 display-7">
                            TRACK AND VIEW YOUR DATA AT ONE PLACE. 
                            <br/>
                            Log In or Sign Up to have your own dedicated dashboard and greater access to our services.</p>
                        <div class="mbr-section-btn mt-3"><a class="btn display-4" href="signup.php" style="background:white;">Go to Dashboard<br></a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="media-container-row align-center mbr-white">
            ...
            <div class="row social-row">
                <div class="social-list align-right pb-2">
                    <div class="soc-item">
                        <a href="https://github.com/ShrutiRawal/MedForHer" target="_blank">
