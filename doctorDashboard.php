            ...
            <div class="card col-12 col-lg-10">
                <div class="card-wrapper">
                    <div class="card-box align-center">
                        <h4 class="card-title mbr-fonts-style align-center mb-4 display-1"><strong style="font-family: 'Kaushan Script', cursive;">Doctor Dashboard</strong></h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="dashboard-main-card">
                    ...
                    <div id="doctor-details">
                        <div style="display:flex"> 
                            <div style="color:#ff4167;font-weight:500;margin-right:10px">Patient Name: </div>
                            <?php
